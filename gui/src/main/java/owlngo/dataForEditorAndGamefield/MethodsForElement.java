...
public class MethodsForElement {
  ...
  static final Map<ElementsInPlayfield.ElementInPlayfield, BackgroundFill>
      elementInPlayfieldBackgroundFillMap = Map.ofEntries(
              Map.entry(ElementsInPlayfield.ElementInPlayfield.NO_ELEMENT,
                      new BackgroundFill(Color.WHITESMOKE, CornerRadii.EMPTY, Insets.EMPTY)),
              Map.entry(ElementsInPlayfield.ElementInPlayfield.OWL,
                      new BackgroundFill(
                              getImagePatternFromFile("C:\\ingo40x40.png"),
                              CornerRadii.EMPTY, Insets.EMPTY)),
              Map.entry(ElementsInPlayfield.ElementInPlayfield.GROUND_NO_LAWN,
                      new BackgroundFill(
                              getImagePatternFromFile("C:\\soil.png"),
                              CornerRadii.EMPTY, Insets.EMPTY)),
              Map.entry(ElementsInPlayfield.ElementInPlayfield.START,
                      new BackgroundFill(Color.GREEN, CornerRadii.EMPTY, Insets.EMPTY)),
              Map.entry(ElementsInPlayfield.ElementInPlayfield.END,
